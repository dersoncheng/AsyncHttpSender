 ...
 * </pre>
 *
 * @see com.hupu.android.net.AsyncHttpClient.AsyncHttpResponseHandler
 * @see com.hupu.android.net.AsyncHttpClient.ResponseHandlerInterface
 * @see com.hupu.android.net.AsyncHttpClient.RequestParams
 */
public class AsyncHttpClient {
     ...
     */
    protected AsyncHttpClient(int httpPort) {
     ...
     */
    protected AsyncHttpClient(int httpPort, int httpsPort) {
     ...
     */
    protected AsyncHttpClient(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
    ...
    public void updateUserAgent(int nt) {
        if (basicUA != null)
    ...
    public void setWangsu()
    {
        if(Proxy.getAddress() != null) {
            HttpHost proxyHost =
                    new HttpHost(Proxy.getAddress().getHost(),
     ...
     * @see com.hupu.android.net.AsyncHttpClient.MyRedirectHandler
     */
...
//        }
    ...
    public static String getUrlWithQueryString(boolean shouldEncodeUrl, String url, RequestParams params) {
        ...
        if (shouldEncodeUrl) {
            try {
            	...
            	HPLog.e(LOG_TAG, "getUrlWithQueryString encoding URL", e);
            }
        }
    ...
    public static void silentCloseInputStream(InputStream is) {
        try {
        	...
        	HPLog.w(LOG_TAG, "Cannot close input stream", e);
        }
    }
    ...
    public static void silentCloseOutputStream(OutputStream os) {
        try {
        	...
        	HPLog.w(LOG_TAG, "Cannot close output stream", e);
        }
    }
    ...
    public static void endEntityViaReflection(HttpEntity entity) {
        if (entity instanceof HttpEntityWrapper) {
            try {
            	...
            	HPLog.e(LOG_TAG, "wrappedEntity consume", t);
            }
        }
    }

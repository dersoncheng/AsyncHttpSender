...
import com.hupu.android.net.AsyncHttpClient.toolbox.HPNetworkError;
    ...
    public void run() {
        ...
        try {
            ...
            if (!isCancelled() && responseHandler != null) {
            	...
            	HPLog.e("AsyncHttpRequest", "makeRequestWithRetries returned error, but handler is null", e);
            }
        }
        ...
        try {
            while (retry) {
                try {
                    ...
                    error = new HPNetworkError("网络异常，稍后请重试！", e);
            ...
            error = new HPNetworkError("网络异常，稍后请重试！");
